...
export const Activity = () => {
    return <Card className="mt-4">
        <CardHeader>
            ...
            <CardDescription>Visual representation of platform activity</CardDescription>
        </CardHeader>
        <CardContent>
                ...
                {Array.from({ length: 12 }).map((_, i) => (
                    <div key={i} className="flex w-full flex-col items-center gap-2">
                        <div className="flex h-full w-full flex-col justify-end gap-1">
                            <div className="w-full rounded-sm bg-blue-500" style={{ height: `${Math.random() * 100}%` }}></div>
                            <div className="w-full rounded-sm bg-green-500" style={{ height: `${Math.random() * 80}%` }}></div>
                            <div className="w-full rounded-sm bg-yellow-500" style={{ height: `${Math.random() * 60}%` }}></div>
                            <div className="w-full rounded-sm bg-purple-500" style={{ height: `${Math.random() * 40}%` }}></div>
                        </div>
