          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">
                      {dashboardData?.data?.jobApplication?.totalApplications ??
                        0}
                    </div>
                    ...
                    <div className="mt-4 space-y-2">
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-medium">
                          {dashboardData?.data?.jobApplication?.totalPending ??
                            0}
                        </span>
                      </div>
                      <Progress
                  ...
                  <CardContent>
                    ...
                    <div className="mt-4 space-y-2">
                      ...
                      <Progress
                        value={
                          (dashboardData?.data?.user?.totalUsers ?? 0) > 0
                            ? ((dashboardData?.data?.user?.totalActiveUsers ??
                                0) /
                                (dashboardData?.data?.user?.totalUsers ?? 1)) *
                              100
                            : 0
                        }
                        className="h-2"
                      ...
                      <Progress
                        value={
                          (dashboardData?.data?.user?.totalUsers ?? 0) > 0
                            ? ((dashboardData?.data?.user?.totalInactiveUsers ??
                                0) /
                                (dashboardData?.data?.user?.totalUsers ?? 1)) *
                              100
                            : 0
                  ...
                  <CardContent>
                    ...
                    <div className="mt-4 space-y-2">
                      ...
                      <Progress
                        value={
                          (dashboardData?.data?.review?.avgStarRating ?? 0) > 0
                            ? ((dashboardData?.data?.review?.avgStarRating ??
                                0) /
                                5) *
                              100
                            : 0
                      ...
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-medium">
                          {dashboardData?.data?.review?.totalPendingReviews ??
                            0}
                        </span>
                      </div>
                      <Progress
                        value={
                          (dashboardData?.data?.review?.totalReviews ?? 0) > 0
                            ? ((dashboardData?.data?.review
                                ...
                                (dashboardData?.data?.review?.totalReviews ??
                                  1)) *
                              100
                            : 0
                        }
                    ...
                    <div className="mt-4 space-y-2">
                      ...
                      <Progress
                        value={
                          (dashboardData?.data?.query?.totalQueries ?? 0) > 0
                            ? ((dashboardData?.data?.query?.totalNew ?? 0) /
                                (dashboardData?.data?.query?.totalQueries ??
                                  1)) *
                              100
                            : 0
                        }
                      ...
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="flex items-center font-medium">
                          ...
                          {formatResponseTime(
                            dashboardData?.data?.query?.avgResponseTime ?? 0
                          )}
                        </span>
                      </div>
                    </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <div className="mt-4 space-y-2">
                      ...
                      <Progress
                        value={
                          (dashboardData?.data?.hiringStats?.totalHiringPosts ??
                            0) > 0
                            ? ((dashboardData?.data?.hiringStats
                                ?.openPositions ?? 0) /
                                (dashboardData?.data?.hiringStats
                      ...
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-medium">
                          {(dashboardData?.data?.hiringStats
                            ?.totalHiringPosts ?? 0) -
                            (dashboardData?.data?.hiringStats?.openPositions ??
                              0)}
                        </span>
                      </div>
                      <Progress
              ...
              {dashboardData?.data?.blog && (
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">
                      {dashboardData?.data?.blog.totalBlogs}
                    </div>
                    <p className="text-xs text-muted-foreground">
                      Total blog posts
                    </p>
                      ...
                      <div className="rounded-lg bg-muted p-4">
                        ...
                        <div className="mt-3 flex items-center justify-between">
                          ...
                          <Link
                            ...
                            className="flex h-8 w-24 items-center justify-center rounded-md bg-muted-foreground/10 text-xs font-medium"
                          >
                            View All
                          </Link>
                        </div>
            ...
            <Card className="mt-4">
              <CardHeader>
                ...
                <CardDescription>
                  Summary of all key metrics across the platform
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                  ...
                  <div className="rounded-lg border p-3">
                    ...
                    <p className="mt-2 text-2xl font-bold">
                      {dashboardData?.data?.user.totalUsers}
                    </p>
                  </div>
                  <div className="rounded-lg border p-3">
                    <div className="flex items-center gap-2">
