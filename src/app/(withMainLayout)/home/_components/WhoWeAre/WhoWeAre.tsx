      ...
      >
        {services.map((service) => (
          <StaggerItem key={service.title}>
            <div className="p-4 hover:-translate-y-2.5 transform duration-300 md:p-6 lg:p-7 tracking-tight rounded-3xl bg-background h-full">
        ...
        <ScrollScaleIn>
          <div className="relative bg-primary p-4 md:p6 lg:p-7 !pb-0 rounded-3xl text-white md:col-span-3 lg:col-span-1 min-h-[300px] md:min-h-[460px] lg:min-h-full">
