        ...
        >
          <div className="relative  flex items-center min-w-[180px] w-fit   h-12 overflow-hidden">
            <span className="flex items-center w-10 h-10 rounded-[10px] bg-[#5865F2]  transition-all duration-500 ease-in-out group-hover:w-full group-hover:justify-between px-3">
              ...
              <span className="absolute right-5 opacity-0 translate-y-8 transition-all duration-400 ease-out group-hover:opacity-100 group-hover:translate-y-0 text-white">
                {text ? text : "Get in touch"}
              </span>
            </span>

            <p className="absolute right-3  transition-all  duration-300 ease-in-out  group-hover:-translate-y-8 group-hover:opacity-0">
              {text ? text : "Get in touch"}
            </p>
          </div>
        </div>
