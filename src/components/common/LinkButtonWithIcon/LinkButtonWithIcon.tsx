      ...
      <Link className="" href={link ? link : "/"}>
        ...
        >
          <div className="relative  flex items-center min-w-[180px] w-fit   h-12 overflow-hidden">
            <span className="flex items-center w-10 h-10 rounded-[10px] bg-primary  transition-all duration-500 ease-in-out group-hover:w-full group-hover:justify-between px-3">
